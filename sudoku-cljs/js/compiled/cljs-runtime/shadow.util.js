...
var len__4730__auto___49090 = arguments.length;
var i__4731__auto___49091 = (0);
while(true){
if((i__4731__auto___49091 < len__4730__auto___49090)){
args__4736__auto__.push((arguments[i__4731__auto___49091]));

var G__49092 = (i__4731__auto___49091 + (1));
i__4731__auto___49091 = G__49092;
continue;
} else {
}
break;
...
/** @this {Function} */
shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq49024){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq49024));
});
...
var len__4730__auto___49099 = arguments.length;
var i__4731__auto___49100 = (0);
while(true){
if((i__4731__auto___49100 < len__4730__auto___49099)){
args_arr__4751__auto__.push((arguments[i__4731__auto___49100]));

var G__49102 = (i__4731__auto___49100 + (1));
i__4731__auto___49100 = G__49102;
continue;
} else {
}
break;
...
/** @this {Function} */
shadow.util.log.cljs$lang$applyTo = (function (seq49043){
var G__49044 = cljs.core.first(seq49043);
var seq49043__$1 = cljs.core.next(seq49043);
var G__49045 = cljs.core.first(seq49043__$1);
var seq49043__$2 = cljs.core.next(seq49043__$1);
var G__49046 = cljs.core.first(seq49043__$2);
var seq49043__$3 = cljs.core.next(seq49043__$2);
var G__49047 = cljs.core.first(seq49043__$3);
var seq49043__$4 = cljs.core.next(seq49043__$3);
var G__49048 = cljs.core.first(seq49043__$4);
var seq49043__$5 = cljs.core.next(seq49043__$4);
var G__49049 = cljs.core.first(seq49043__$5);
var seq49043__$6 = cljs.core.next(seq49043__$5);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49044,G__49045,G__49046,G__49047,G__49048,G__49049,seq49043__$6);
});

shadow.util.log.cljs$lang$maxFixedArity = (6);

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__49070){
var vec__49071 = p__49070;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49071,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49071,(1),null);
