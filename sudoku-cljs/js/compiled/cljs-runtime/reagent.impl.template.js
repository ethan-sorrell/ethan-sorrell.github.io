...
var G__51083 = o;
(G__51083[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__51337__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51337 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51338__i = 0, G__51338__a = new Array(arguments.length -  0);
while (G__51338__i < G__51338__a.length) {G__51338__a[G__51338__i] = arguments[G__51338__i + 0]; ++G__51338__i;}
  args = new cljs.core.IndexedSeq(G__51338__a,0,null);
} 
return G__51337__delegate.call(this,args);};
G__51337.cljs$lang$maxFixedArity = 0;
G__51337.cljs$lang$applyTo = (function (arglist__51339){
var args = cljs.core.seq(arglist__51339);
return G__51337__delegate(args);
});
G__51337.cljs$core$IFn$_invoke$arity$variadic = G__51337__delegate;
return G__51337;
})()
;
} else {
...
var G__51114 = o;
(G__51114[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__51347__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51347 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51348__i = 0, G__51348__a = new Array(arguments.length -  0);
while (G__51348__i < G__51348__a.length) {G__51348__a[G__51348__i] = arguments[G__51348__i + 0]; ++G__51348__i;}
  args = new cljs.core.IndexedSeq(G__51348__a,0,null);
} 
return G__51347__delegate.call(this,args);};
G__51347.cljs$lang$maxFixedArity = 0;
G__51347.cljs$lang$applyTo = (function (arglist__51349){
var args = cljs.core.seq(arglist__51349);
return G__51347__delegate(args);
});
...
var G__51152 = props;
var G__51152__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51152,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51152);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51152__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__51175){
...
var props = map__51176__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51176__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__51176,map__51176__$1,props,class$){
return (function (c){
...
});})(map__51176,map__51176__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__51210){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51211__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__51211,map__51211__$1,on_write){
return (function (){
...
});})(node_value,map__51211,map__51211__$1,on_write))
);
} else {
...
var G__51223 = jsprops;
(G__51223["defaultValue"] = value);

(G__51223["onChange"] = ((function (G__51223,v,value,on_change){
return (function (p1__51220_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__51220_SHARP_);
});})(G__51223,v,value,on_change))
);
...
var vec__51229 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51229,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51229,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51229,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___51417 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___51417 == null)){
} else {
var key_51418 = temp__5739__auto___51417;
(jsprops["key"] = key_51418);
}
...
var temp__5739__auto___51421 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___51421 == null)){
} else {
var key_51422 = temp__5739__auto___51421;
reagent.impl.template.oset(jsprops,"key",key_51422);
}
...
var G__51238 = reagent.impl.template.__GT_NativeWrapper();
(G__51238["name"] = c);
...
var G__51239 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__51239) : reagent.impl.template.as_element.call(null,G__51239));
} else {
...
var len__4730__auto___51429 = arguments.length;
var i__4731__auto___51430 = (0);
while(true){
if((i__4731__auto___51430 < len__4730__auto___51429)){
args__4736__auto__.push((arguments[i__4731__auto___51430]));

var G__51431 = (i__4731__auto___51430 + (1));
i__4731__auto___51430 = G__51431;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq51252){
var G__51253 = cljs.core.first(seq51252);
var seq51252__$1 = cljs.core.next(seq51252);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51253,seq51252__$1);
});
...
break;
default:
var G__51444 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__51444;
continue;
...
var n__4607__auto___51456 = a.length;
var i_51457 = (0);
while(true){
if((i_51457 < n__4607__auto___51456)){
(a[i_51457] = reagent.impl.template.as_element((a[i_51457])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___51459 = a.length;
var i_51460 = (0);
while(true){
if((i_51460 < n__4607__auto___51459)){
var val_51461 = (a[i_51460]);
if(((cljs.core.vector_QMARK_(val_51461)) && ((reagent.impl.template.key_from_vec(val_51461) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_51460] = reagent.impl.template.as_element(val_51461));

var G__51462 = (i_51460 + (1));
i_51460 = G__51462;
continue;
} else {
}
...
var ctx = ({});
var vec__51317 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51317,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51317,(1),null);
...
var G__51330 = (cljs.core.count(argv) - first_child);
switch (G__51330) {
case (0):
...
case (1):
var G__51331 = comp;
var G__51332 = jsprops;
var G__51333 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__51331,G__51332,G__51333);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__51330){
