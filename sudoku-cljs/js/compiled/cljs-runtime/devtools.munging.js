...
var o40928 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40928["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40929 = temp__5733__auto____$1;
return (o40929["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40610__auto__ = f;
return (o__40610__auto__["toString"]).call(o__40610__auto__);
} else {
return "";
}
}catch (e40936){var _ = e40936;
return "";
}});
...
try{var o__40610__auto___41254 = t;
(o__40610__auto___41254["cljs$lang$ctorPrWriter"]).call(o__40610__auto___41254,t,writer);
}catch (e40943){var __41255 = e40943;
}
...
var char_code = (function (){var o__40610__auto__ = (new String(char$));
return (o__40610__auto__["charCodeAt"]).call(o__40610__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40610__auto__ = String;
return (o__40610__auto__["fromCharCode"]).call(o__40610__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41006 = num_code;
switch (G__41006) {
case (1):
return (185);
...
var o__40610__auto__ = String;
return (o__40610__auto__["fromCharCode"]).call(o__40610__auto__,superscript_code);
});
/**
...
}catch (e41018){var _e__40622__auto__ = e41018;
return false;
}})())){
...
var vec__41019 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41019,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o41037 = temp__5733__auto__;
var temp__5733__auto____$1 = (o41037["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o41038 = temp__5733__auto____$1;
return (o41038["nameToPath"]);
} else {
return null;
}
} else {
...
var G__41282 = (i__4731__auto___41280 + (1));
i__4731__auto___41280 = G__41282;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41044){
var vec__41045 = p__41044;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41045,(0),null);
...
var G__41284 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41285 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41284;
remaining_tokens = G__41285;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41040){
var G__41042 = cljs.core.first(seq41040);
var seq41040__$1 = cljs.core.next(seq41040);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41042,seq41040__$1);
});
...
var vec__41052 = cljs.core.split_with((function (p1__41051_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41051_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41052,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41052,(1),null);
...
var vec__41058 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41058,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41058,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41288 = cljs.core.rest(remaining_tokens);
var G__41289 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41288;
name_tokens = G__41289;
continue;
} else {
...
var vec__41065 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41065,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41065,(1),null);
var vec__41068 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41068,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41068,(1),null);
var vec__41071 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41071,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41071,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41071,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41071,(3),null);
...
var vec__41088 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41088,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41088,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41088,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41088,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41088,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41088,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__41097 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41097,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41097,(1),null);
var vec__41100 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41100,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41100,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41108 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41108) : devtools.munging.parse_fn_info_deep.call(null,G__41108));
})()));
}
} else {
return fn_info;
...
var G__41331 = (arity + (1));
var G__41332 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41131){
var vec__41132 = p__41131;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41132,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41132,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41147_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41148_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41154){
var vec__41155 = p__41154;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41155,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41149){
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41198__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41198__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41198__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41198__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41199 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41199,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41199,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41199,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41199,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41199,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41199,(5),null);
...
var o__40610__auto__ = f;
return (o__40610__auto__["getBasis"]).call(o__40610__auto__);
});
/**
...
}catch (e41205){var _e__40622__auto__ = e41205;
...
var G__41376 = (obj[cljs.core.first(path)]);
var G__41377 = cljs.core.rest(path);
obj = G__41376;
path = G__41377;
continue;
} else {
...
return (function (accum,p__41217){
var vec__41218 = p__41217;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41218,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41218,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41234){
var vec__41235 = p__41234;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41235,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41235,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41235,(2),null);
...
return (function (p__41244){
var vec__41245 = p__41244;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41245,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41245,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__41245,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__41239_SHARP_){
return (obj[cljs.core.first(p1__41239_SHARP_)]);
});})(name,sorted_matches,vec__41245,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
