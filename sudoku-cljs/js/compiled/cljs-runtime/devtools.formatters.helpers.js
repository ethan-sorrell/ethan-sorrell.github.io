...
var G__41324 = devtools.prefs.pref(v);
v = G__41324;
continue;
} else {
return v;
...
}catch (e41269){var _e__40622__auto__ = e41269;
return false;
}})();
...
}catch (e41277){var _e__40622__auto__ = e41277;
return false;
}})();
...
}catch (e41281){var _e__40622__auto__ = e41281;
return false;
}}
}
});
...
var vec__41296 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41296,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41296,(1),null);
...
return cljs.core.some((function (p1__41309_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41309_SHARP_);
}),template);
});
