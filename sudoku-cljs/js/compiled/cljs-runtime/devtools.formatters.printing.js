...
var len__4730__auto___41464 = arguments.length;
var i__4731__auto___41466 = (0);
while(true){
if((i__4731__auto___41466 < len__4730__auto___41464)){
args__4736__auto__.push((arguments[i__4731__auto___41466]));

var G__41469 = (i__4731__auto___41466 + (1));
i__4731__auto___41466 = G__41469;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41340){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41341,G__41342,seq41340__$2);
});
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41405__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41411){var _e__40622__auto__ = e41411;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e41414){var _e__40622__auto__ = e41414;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41421 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41422 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41422;

try{var map__41428 = opts;
var map__41428__$1 = (((((!((map__41428 == null))))?(((((map__41428.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41428.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41428):map__41428);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41428__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41421;
}});
...
;
var temp__5733__auto___41527 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___41527)){
var managed_print_level_41528 = temp__5733__auto___41527;
var _STAR_print_level_STAR__orig_val__41449_41529 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41450_41530 = managed_print_level_41528;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41450_41530;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__41449_41529,_STAR_print_level_STAR__temp_val__41450_41530,managed_print_level_41528,temp__5733__auto___41527,writer,opts,job_fn){
return (function (p1__41445_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41445_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__41449_41529,_STAR_print_level_STAR__temp_val__41450_41530,managed_print_level_41528,temp__5733__auto___41527,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41449_41529;
}} else {
job_fn();
}
