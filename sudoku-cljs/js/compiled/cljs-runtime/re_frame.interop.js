...
return [(function (){var pred__51621 = cljs.core.instance_QMARK_;
var expr__51622 = reactive_val;
if(cljs.core.truth_((pred__51621.cljs$core$IFn$_invoke$arity$2 ? pred__51621.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__51622) : pred__51621.call(null,reagent.ratom.RAtom,expr__51622)))){
return "ra";
} else {
if(cljs.core.truth_((pred__51621.cljs$core$IFn$_invoke$arity$2 ? pred__51621.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__51622) : pred__51621.call(null,reagent.ratom.RCursor,expr__51622)))){
return "rc";
} else {
if(cljs.core.truth_((pred__51621.cljs$core$IFn$_invoke$arity$2 ? pred__51621.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__51622) : pred__51621.call(null,reagent.ratom.Reaction,expr__51622)))){
return "rx";
} else {
if(cljs.core.truth_((pred__51621.cljs$core$IFn$_invoke$arity$2 ? pred__51621.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__51622) : pred__51621.call(null,reagent.ratom.Track,expr__51622)))){
return "tr";
} else {
return "other";
}
